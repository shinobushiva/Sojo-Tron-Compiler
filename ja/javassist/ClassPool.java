...
public class ClassPool {
	...
	/**
	 * Records a name that never exists. For example, a package name can be
	 * recorded by this method. This would improve execution performance since
	 * <code>get()</code> does not search the class path at all if the given
	 * name is an invalid name recorded by this method. Note that searching the
	 * class path takes relatively long time.
	 * 
	 * @param name
	 *            a class name (separeted by dot).
	 */
	 ...
	 * <code>getClassInfo</code> in <code>javassist.bytecode.ClassPool</code>.
	 ...
	 * detached <code>ClassPath</code> object cannot be added to the pathagain.
	 */
